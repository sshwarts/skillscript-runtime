...
describe("T7 — package.json polish", () => {
  it("1. version is 0.3.2 (|json_parse filter + and/or/not compound conditions + filter chain support)", () => {
    expect(PACKAGE_JSON["version"]).toBe("0.3.2");
  });
...
describe("T7 — distributed code surface", () => {
  ...
  it("7. narrow-core LOC ceiling holds (< 5650 / 20 files; v0.2.10 → 5100, v0.2.12 → 5200, v0.3.0 → 5400, v0.3.1 → 5500, v0.3.2 → 5650)", () => {
    ...
    expect(Number(locStr)).toBeLessThan(5650);
